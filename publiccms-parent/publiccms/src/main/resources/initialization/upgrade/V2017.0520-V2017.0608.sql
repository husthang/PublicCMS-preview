...
UPDATE `sys_moudle` SET name = '页面片段模板',attached = '<i class="icon-list-alt icon-large"></i>',`url` =  'placeTemplate/list',`authorized_url` =  NULL,`parent_id` = 38 WHERE  `sys_moudle`.`id` =42;
...
UPDATE `sys_moudle` SET `authorized_url` =  '',`parent_id` = 113 WHERE  `sys_moudle`.`id` in(50,51,52,53,54);
...
UPDATE `sys_moudle` SET name = '页面片段管理',attached = '<i class="icon-list-alt icon-large"></i>',`url` =  null,`authorized_url` =  null,`parent_id` = 30,`sort` = 1 WHERE  `sys_moudle`.`id` =107;
