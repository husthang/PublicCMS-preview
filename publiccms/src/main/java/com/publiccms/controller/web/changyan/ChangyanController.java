package com.publiccms.controller.web.changyan;
...
import com.publiccms.controller.web.changyan.pojo.LogoutResult;
import com.publiccms.controller.web.changyan.pojo.User;
import com.publiccms.controller.web.changyan.pojo.UserInfo;
...
public class ChangyanController extends AbstractController {
    ...
    public MappingJacksonValue login(User user, String callback, HttpServletRequest request, HttpSession session,
        ...
        if (empty(user.getUser_id())) {
            ...
            if (null != sysuser && site.getId() == sysuser.getSiteId() && !sysuser.isDisabled()) {
