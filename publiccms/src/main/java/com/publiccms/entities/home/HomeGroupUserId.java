...
/**
 * HomeGroupUserId generated by hbm2java
 */
@Embeddable
public class HomeGroupUserId implements java.io.Serializable {
    ...
    public HomeGroupUserId(long groupId, long userId) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof HomeGroupUserId))
            return false;
        HomeGroupUserId castOther = (HomeGroupUserId) other;
