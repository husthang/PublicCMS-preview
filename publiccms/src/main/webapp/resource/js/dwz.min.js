...
( function($) {
	...
	$.extend($.dwz.accordion, {
		defaults : {
			selectedClass : "collapsable" ,selectedIconClass : "icon-chevron-down", alwaysOpen : true , animated : 'slide' , event : "click" , header : ".accordionHeader" , autoheight : true , running : 0 ,
...
function initLayout() {
	...
	$("#splitBar, #splitBarProxy").height($(window).height() - $('header').height());
	$("#taskbar").css({
...
var navTab = {
	...
	_getScrollBarW : function() {
		return this.componentBox.width() - 122;
	} ,
